...
def countFingers(image, results, draw=True, display=True):
    ...
    if draw:
        ...
        if results.multi_hand_landmarks:
            cv2.putText(output_image, " Total Fingers: ", (15, 30), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 0), 1)
            cv2.putText(output_image, str(sum(count.values())), (600, 300), cv2.FONT_HERSHEY_SIMPLEX, 4, (255, 255, 0), 3)
